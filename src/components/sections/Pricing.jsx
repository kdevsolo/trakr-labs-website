    ...
    <section id="pricing" className="relative px-4 py-24">
      <div className="mx-auto max-w-4xl">
        <SectionHeading
          ...
          subtitle="Start free and upgrade when you need AI triage, integrations, and more."
        />
        ...
        <motion.div
          ...
          className="mt-14 grid items-stretch gap-6 pt-3 sm:grid-cols-2"
        >
          {pricing.map((tier) => (
            <motion.div
              key={tier.name}
            ...
            >
              {tier.highlighted && (
                <span className="absolute -top-3 left-1/2 z-10 -translate-x-1/2 whitespace-nowrap rounded-full bg-brand-600 px-3 py-1 text-[11px] font-semibold tracking-wide text-white uppercase">
                  Premium plan
                </span>
              )}
              ...
              <div className="relative flex flex-1 flex-col">
                ...
                <a
                  ...
                  className={`mt-8 flex w-full items-center justify-center rounded-xl px-6 py-3 text-sm font-semibold transition-colors active:scale-[0.98] ${
                    tier.highlighted
